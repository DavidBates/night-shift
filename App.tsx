...
const NightShift = () => {
  ...
  return (
    ...
    >
        ...
        <div className="fixed bottom-0 right-10 z-[55] w-64 md:w-80 h-16 group">
            <button 
                onClick={toggleCamera}
                onTouchStart={toggleCamera} // Better touch response
            ...
            >
                ...
                <span className="font-black text-xl tracking-widest">{cameraOpen ? 'CLOSE' : 'MONITOR'}</span>
            </button>
        </div>
